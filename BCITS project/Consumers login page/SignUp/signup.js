function validation() {
    ...
    if (fnameValid && lnameValid && emailValid && pnumberValid && pswValid && cpswValid && rrnumValid && houseNumValid && inputAddress1Valid && inputAddress2Valid) {
        window.location.href = "/login/consumerlogin.html";
    }
}
