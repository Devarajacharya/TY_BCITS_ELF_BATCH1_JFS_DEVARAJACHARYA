...
import com.bcits.springsecurityrest.filters.CustomUsernamePasswordAuthenticationFilter;
...
public class EmployeeSecurityConfig  extends WebSecurityConfigurerAdapter{
	...
	@Autowired
	private MysimpleAuthenticationsuccessHandler successHandler;
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		.and()
		.authorizeRequests()
		.antMatchers("/getAllEmployee").hasRole("ADMIN")
		.and()
